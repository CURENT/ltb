...
"""
Main entry point for the LTB CLI and scripting interfaces.
"""
...
def config_logger(stream_level=logging.INFO, *,
    ...
    """
    Configure an LTB logger with a `FileHandler` and a `StreamHandler`.
...
def remove_output(recursive=False):
    """
    TODO: Remove the outputs generated by ANDES, AMS, AGVis, and DiME.
...
def run(filename='', input_path='', verbose=20,
    ...
    logger.warning("Function have not been implemented")
    return True
...
def print_license():
    """
    Print out LTB license to stdout.
    """

    print(f"""
    CURENT LTB version {ltb.__version__}

    Copyright (c) 2015-2023, CURENT LTB Team
...
def doc(**kwargs):
    ...
    TODO: Documentation.
    """
    logger.warning("Doc have not been implemented")
...
def plot(**kwargs):
    ...
    TODO: Plot.
    """
    logger.warning("Plot have not been implemented")


def versioninfo():
    """
    Print version info for LTB and dependencies.
    """
    ...
    versions = {'Python': platform.python_version(),
                'ltb': get_versions()['version'],
                'andes': andes.__version__,
                'ams': ams.__version__,
                'agvis': agvis.__version__,
